(function () {
    ...
    pets.forEach((pet, i) => {
        ...
        col.innerHTML = `<div class='list-group'><div class='list-group-item list-group-item-action flex-column align-items-start active'><div class='d-flex w-100 justify-content-between'><h5 class='mb-1'>${pet['name']}</h5><small>${pet['age']}</small></div><p class='mb-1'>${pet['desc']}</p><small>${pet['species']}</small></div></div>`
